...
| [test_quota_dashboard.py](tests/test_quota_dashboard.py) | 34 tests — the box-local quota dashboard (`scripts/sysadmin/quota_dashboard.py`): the regeneration floor bounds probe volume, the trigger threshold, the page's own probe loop |
