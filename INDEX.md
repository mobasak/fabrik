...
| [test_check_doc_stubs.py](tests/test_check_doc_stubs.py) | 12 tests for the advisory force-fill — every placeholder sentinel, trigger detectors (compose/env/schema/route), registry alignment, fail-safe exit 0 on git/detector error, filled-doc-with-date-format no false-WARN. |
