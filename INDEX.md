...
- `scripts/kilo-benchmarks/models_browser.html` - Single-file searchable browser of every chat + embedding model in `kilo_agents.db` (462 models). Generated by `export_models_browser.py`; open in any browser, no server.
