...
| **capabilities.json** | GENERATED machine-readable capability catalog — every invokable tool (name/kind/summary/invoke/status/defects/doc_link/verified_at) across the 9 surfaces, liveness-verified. The manifest a cold AI agent parses first. Human twin: `docs/CAPABILITIES.md`. | AUTO-GENERATED by `scripts/generate_capability_index.py` (do not hand-edit) | Regenerated (daily) |
...
| **docs/CAPABILITIES.md** | GENERATED capability catalog (llms.txt-style) — every invokable tool across the 9 surfaces (cli/driver/registrar/script/lib-module/scaffold/rules-pack/hook/command), liveness-verified; a cold AI agent reads this first. Machine-readable twin: `capabilities.json`. Never hand-edit — regenerated by `scripts/generate_capability_index.py` (daily via `daily_refresh.sh`). | AUTO-GENERATED (do not hand-edit) | Regenerated (daily) |
