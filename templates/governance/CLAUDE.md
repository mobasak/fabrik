...
- **⚠️ HANDLE-NOW — a message you OPEN is a message you FINISH, in the same session.** Read → validate
  ...
  the reply and open the pipeline at its stage, never half-build it inline; (iii) a **RIGHT-NOW fix**,
