...
- **Version literals owed to their OWN turns** (`rules_render_versions.py --check`, 2026-09-22): `65-rag-search.md` `pgvector:pg16` · `tojlo-design-system.md` `PG16` · `mobile-app/00-domain-mobile-app.md` `PostgreSQL 16` — all three unevaluated; row 6 at each.
