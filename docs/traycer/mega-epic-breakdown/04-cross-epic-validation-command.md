...
| Has `### Success Criteria` — count by epic flavour | Delta-feature epic: 5–8 items. Retrofit epic (Title `[Name]` starts `Retrofit:`): 3–5 items permitted per `03-expand-epic-files-command` § Step 2–86 | Below per-flavour minimum |
