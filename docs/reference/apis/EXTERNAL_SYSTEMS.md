...
Plex, Jellyfin, Emby, qBittorrent, SABnzbd, NZBGet, Heimdall, Homer, Organizr, Borg, OpenVPN (1 inventory mention, not running on any host), Code Server, Gitea, Caddy, LinuxServer.io, hotio.dev, TrueForge/ContainerForge, Yoast SEO, Rank Math, WPForms, Contact Form 7, Google Analytics 4, Google Tag Manager, Gmail SMTP
