...
3. Does it carry a `SKIP:` clause naming the sibling command each near-miss belongs to? (11 of 31 sources carry no `SKIP:` — absence is a finding unless the command has no plausible sibling.)
