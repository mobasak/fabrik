...
**Generated:** 2026-08-08 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
|---:|---|:-:|---|:-:|:-:|---:|---:|---:|---:|---:|---:|---:|---:|:-:|---:|---:|
| 1 | `minimax/minimax-m2.5` | ✅ | Inceptron | ✅ | — | 54 | 0.220 | 0.900 | 75.8 | — | — | 1436 | 204k | **A†** | 81% | 0.572 |
| 2 | `deepseek/deepseek-v3.2` | ✅ | Baidu | ✅ | — | 63 | 0.260 | 0.380 | 70.0 | 70.2 | — | 1431 | 163k | **B+†** | 78% | 0.551 |
...
| 5 | `qwen/qwen3-coder-30b-a3b-instruct` | ✅ | INVALID_ID_7079 | — | ✅ | 104 | 0.070 | 0.270 | — | — | — | — | 262k | **C+** | — | 0.458 |
...
| 8 | `minimax/minimax-m3` | ✅ | GMICloud | ✅ | — | 109 | 0.300 | 1.200 | — | — | 45 | 1485 | 1048k | **B†** | 67% | 0.427 |
| 9 | `deepseek/deepseek-v4-pro` | ✅ | Baidu | ✅ | — | 57 | 0.435 | 0.870 | — | — | 44 | 1491 | 1048k | **A+†** | 92% | 0.421 |
| 10 | `z-ai/glm-4.7-flash` | ✅ | DeepInfra | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **A+†** | 95% | 0.413 |
| 11 | `deepseek/deepseek-v4-flash` | ✅ | OpenInference | ✅ | — | 110 | 0.140 | 0.280 | — | — | 38 | 1465 | 1048k | **A+†** | 94% | 0.400 |
| 12 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 69 | 0.270 | 1.080 | — | — | 38 | 1448 | 204k | **A†** | 84% | 0.369 |
| 13 | `z-ai/glm-5.2` | ✅ | Novita | ✅ | — | 102 | 0.405 | 1.272 | — | — | 44 | — | 1048k | **A+†** | 96% | 0.321 |
| 14 | `qwen/qwen3-coder-next` | ✅ | Parasail | — | — | 148 | 0.120 | 0.800 | — | — | 21 | — | 262k | **A+†** | 90% | 0.256 |
...
| 21 | `deepseek/deepseek-r1-distill-llama-70b` | ✅ | Novita | ✅ | — | 45 | 0.800 | 0.800 | — | — | — | — | 8k | **A†** | 83% | 0.163 |
| 22 | `deepseek/deepseek-chat` | ✅ | StreamLake | — | — | 42 | 0.257 | 1.029 | — | — | — | 1337 | 163k | **C** | — | 0.160 |
| 23 | `z-ai/glm-4.6v` | ✅ | — | ✅ | — | 33 | 0.300 | 0.900 | — | — | — | — | 131k | **C** | — | 0.157 |
| 24 | `deepseek/deepseek-v3.1-terminus` | ✅ | DeepInfra | ✅ | — | 24 | 0.270 | 1.000 | — | — | — | — | 163k | **C** | — | 0.150 |
...
| 9 | `z-ai/glm-5.1` | ✅ | Baidu | ✅ | — | 74 | 0.952 | 2.992 | — | — | 40 | 1506 | 204k | **A+†** | 98% | 0.400 |
| 10 | `moonshotai/kimi-k2.6` | ✅ | Baidu | ✅ | — | 40 | 0.580 | 2.440 | — | — | 44 | — | 262k | **A+†** | 98% | 0.291 |
| 11 | `moonshotai/kimi-k2.7-code` | ✅ | DeepInfra | ✅ | — | 39 | 0.700 | 3.500 | — | — | 43 | — | 262k | **A+†** | 98% | 0.277 |
| 12 | `z-ai/glm-4.7` | ✅ | DeepInfra | ✅ | — | 70 | 0.400 | 1.750 | — | — | — | 1460 | 204k | **B** | — | 0.245 |
...
| `deepseek/deepseek-chat` | 0.257 | 1.029 | 42 | 163k | 1337 | — | 0.160 |
