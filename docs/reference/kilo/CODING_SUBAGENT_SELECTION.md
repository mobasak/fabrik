...
**Generated:** 2026-08-07 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
| 8 | `minimax/minimax-m3` | ✅ | GMICloud | ✅ | — | 103 | 0.300 | 1.200 | — | — | 45 | 1485 | 1048k | **B†** | 67% | 0.426 |
| 9 | `deepseek/deepseek-v4-pro` | ✅ | StreamLake | ✅ | — | 60 | 0.435 | 0.870 | — | — | 44 | 1491 | 1048k | **A+†** | 92% | 0.422 |
| 10 | `z-ai/glm-4.7-flash` | ✅ | DeepInfra | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **A+†** | 95% | 0.413 |
| 11 | `deepseek/deepseek-v4-flash` | ✅ | DigitalOcean | ✅ | — | 110 | 0.088 | 0.176 | — | — | 38 | 1462 | 1048k | **A+†** | 94% | 0.399 |
| 12 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 69 | 0.270 | 1.080 | — | — | 38 | 1448 | 204k | **A†** | 84% | 0.369 |
| 13 | `qwen/qwen3-coder-next` | ✅ | Parasail | — | — | 136 | 0.120 | 0.800 | — | — | 21 | — | 262k | **A+†** | 90% | 0.255 |
...
| 10 | `z-ai/glm-5.2` | ✅ | Novita | ✅ | — | 108 | 0.546 | 1.716 | — | — | 44 | — | 1048k | **A+†** | 96% | 0.317 |
| 11 | `moonshotai/kimi-k2.6` | ✅ | Chutes | ✅ | — | 40 | 0.570 | 2.400 | — | — | 44 | — | 262k | **A+†** | 98% | 0.292 |
| 12 | `moonshotai/kimi-k2.7-code` | ✅ | DeepInfra | ✅ | — | 43 | 0.700 | 3.500 | — | — | 43 | — | 262k | **A+†** | 98% | 0.279 |
