...
**Generated:** 2026-07-30 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
| 8 | `minimax/minimax-m3` | ✅ | GMICloud | ✅ | — | 76 | 0.300 | 1.200 | — | — | 44 | 1485 | 1048k | **B†** | 67% | 0.417 |
| 9 | `z-ai/glm-4.7-flash` | ✅ | Cloudflare | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **A+†** | 95% | 0.413 |
| 10 | `deepseek/deepseek-v4-flash` | ✅ | DeepInfra | ✅ | — | 112 | 0.140 | 0.280 | — | — | 38 | 1460 | 1048k | **A+†** | 94% | 0.397 |
| 11 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 69 | 0.250 | 1.000 | — | — | 38 | 1448 | 204k | **A†** | 84% | 0.370 |
| 12 | `deepseek/deepseek-v4-pro` | ✅ | DeepSeek | ✅ | — | 71 | 0.435 | 0.870 | — | — | 44 | — | 1048k | **A+†** | 92% | 0.316 |
| 13 | `qwen/qwen3-coder-next` | ✅ | Ionstream | — | — | 139 | 0.180 | 0.900 | — | — | 21 | — | 262k | **A+†** | 90% | 0.254 |
...
| 10 | `z-ai/glm-5.2` | ✅ | StreamLake | ✅ | — | 136 | 0.738 | 2.345 | — | — | 42 | — | 1048k | **A+†** | 96% | 0.310 |
| 11 | `moonshotai/kimi-k2.6` | ✅ | Inceptron | ✅ | — | 38 | 0.646 | 2.720 | — | — | 44 | — | 262k | **A+†** | 98% | 0.288 |
