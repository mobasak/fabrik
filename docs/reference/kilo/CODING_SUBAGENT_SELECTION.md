...
**Generated:** 2026-08-06 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
| 8 | `minimax/minimax-m3` | ✅ | GMICloud | ✅ | — | 89 | 0.300 | 1.200 | — | — | 44 | 1485 | 1048k | **B†** | 67% | 0.420 |
| 9 | `deepseek/deepseek-v4-pro` | ✅ | DeepSeek | ✅ | — | 63 | 0.435 | 0.870 | — | — | 44 | 1491 | 1048k | **A+†** | 92% | 0.420 |
| 10 | `z-ai/glm-4.7-flash` | ✅ | DeepInfra | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **A+†** | 95% | 0.413 |
| 11 | `deepseek/deepseek-v4-flash` | ✅ | DigitalOcean | ✅ | — | 121 | 0.088 | 0.176 | — | — | 38 | 1462 | 1048k | **A+†** | 94% | 0.401 |
| 12 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 69 | 0.270 | 1.080 | — | — | 38 | 1448 | 204k | **A†** | 84% | 0.369 |
| 13 | `qwen/qwen3-coder-next` | ✅ | Parasail | — | — | 133 | 0.120 | 0.800 | — | — | 21 | — | 262k | **A+†** | 90% | 0.254 |
...
| # | Model | OR | OR_prov | Reason | Bench | db_tps | In $/M | Out $/M | SWE | Aider | AA | Arena | Ctx | Doc↔Code | pass@1 | Score |
|---:|---|:-:|---|:-:|:-:|---:|---:|---:|---:|---:|---:|---:|---:|:-:|---:|---:|
| 1 | `z-ai/glm-5` | ✅ | GMICloud | ✅ | — | 68 | 0.950 | 2.550 | 72.8 | — | — | 1461 | 204k | **A†** | 90% | 0.564 |
...
| 10 | `z-ai/glm-5.2` | ✅ | Decart | ✅ | — | 122 | 0.760 | 2.420 | — | — | 42 | — | 1048k | **A+†** | 96% | 0.307 |
| 11 | `moonshotai/kimi-k2.6` | ✅ | Chutes | ✅ | — | 38 | 0.589 | 2.480 | — | — | 44 | — | 262k | **A+†** | 98% | 0.290 |
| 12 | `moonshotai/kimi-k2.7-code` | ✅ | Ambient | ✅ | — | 42 | 0.700 | 3.500 | — | — | 42 | — | 262k | **A+†** | 98% | 0.275 |
...
| 20 | `z-ai/glm-5v-turbo` | ✅ | — | ✅ | — | 36 | 1.200 | 4.000 | — | — | — | — | 202k | **B+†** | 76% | 0.126 |
