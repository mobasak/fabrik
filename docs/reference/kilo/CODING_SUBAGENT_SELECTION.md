...
**Generated:** 2026-08-04 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
| 8 | `deepseek/deepseek-v4-pro` | ✅ | DeepSeek | ✅ | — | 63 | 0.435 | 0.870 | — | — | 44 | 1491 | 1048k | **A+†** | 92% | 0.420 |
| 9 | `minimax/minimax-m3` | ✅ | GMICloud | ✅ | — | 82 | 0.300 | 1.200 | — | — | 44 | 1485 | 1048k | **B†** | 67% | 0.419 |
| 10 | `z-ai/glm-4.7-flash` | ✅ | Cloudflare | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **A+†** | 95% | 0.413 |
| 11 | `deepseek/deepseek-v4-flash` | ✅ | Baidu | ✅ | — | 118 | 0.140 | 0.280 | — | — | 38 | 1462 | 1048k | **A+†** | 94% | 0.400 |
| 12 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 69 | 0.250 | 1.000 | — | — | 38 | 1448 | 204k | **A†** | 84% | 0.370 |
| 13 | `qwen/qwen3-coder-next` | ✅ | Ionstream | — | — | 139 | 0.120 | 0.800 | — | — | 21 | — | 262k | **A+†** | 90% | 0.255 |
...
| 10 | `z-ai/glm-5.2` | ✅ | Decart | ✅ | — | 150 | 0.760 | 2.420 | — | — | 42 | — | 1048k | **A+†** | 96% | 0.311 |
| 11 | `moonshotai/kimi-k2.6` | ✅ | Baidu | ✅ | — | 30 | 0.589 | 2.480 | — | — | 44 | — | 262k | **A+†** | 98% | 0.286 |
| 12 | `moonshotai/kimi-k2.7-code` | ✅ | CoreWeave | ✅ | — | 39 | 0.730 | 3.500 | — | — | 42 | — | 262k | **A+†** | 98% | 0.273 |
