...
**Generated:** 2026-07-31 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
| 8 | `minimax/minimax-m3` | ✅ | GMICloud | ✅ | — | 65 | 0.300 | 1.200 | — | — | 44 | 1485 | 1048k | **B†** | 67% | 0.414 |
| 9 | `z-ai/glm-4.7-flash` | ✅ | Cloudflare | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **A+†** | 95% | 0.413 |
| 10 | `deepseek/deepseek-v4-flash` | ✅ | DeepInfra | ✅ | — | 118 | 0.140 | 0.280 | — | — | 38 | 1460 | 1048k | **A+†** | 94% | 0.398 |
| 11 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 69 | 0.250 | 1.000 | — | — | 38 | 1448 | 204k | **A†** | 84% | 0.370 |
| 12 | `deepseek/deepseek-v4-pro` | ✅ | DeepSeek | ✅ | — | 63 | 0.435 | 0.870 | — | — | 44 | — | 1048k | **A+†** | 92% | 0.314 |
| 13 | `qwen/qwen3-coder-next` | ✅ | Ionstream | — | — | 142 | 0.120 | 0.800 | — | — | 21 | — | 262k | **A+†** | 90% | 0.255 |
| 14 | `minimax/minimax-m2.1` | ✅ | Minimax | ✅ | — | 61 | 0.300 | 1.200 | — | — | — | 1430 | 204k | **B-** | — | 0.225 |
| 15 | `z-ai/glm-4.5-air` | ✅ | SiliconFlow | ✅ | — | 105 | 0.130 | 0.850 | — | — | — | 1410 | 131k | **A†** | 80% | 0.224 |
...
| 5 | `moonshotai/kimi-k2.5` | ✅ | DeepInfra | ✅ | — | 46 | 0.570 | 2.850 | 70.8 | — | — | — | 262k | **A+†** | 98% | 0.462 |
...
| 10 | `z-ai/glm-5.2` | ✅ | Decart | ✅ | — | 90 | 0.966 | 3.036 | — | — | 42 | — | 1048k | **A+†** | 96% | 0.295 |
| 11 | `moonshotai/kimi-k2.7-code` | ✅ | CoreWeave | ✅ | — | 42 | 0.730 | 3.500 | — | — | 42 | — | 262k | **A+†** | 98% | 0.275 |
| 12 | `moonshotai/kimi-k2.6` | ✅ | Inceptron | ✅ | — | 37 | 0.950 | 4.000 | — | — | 44 | — | 262k | **A+†** | 98% | 0.274 |
