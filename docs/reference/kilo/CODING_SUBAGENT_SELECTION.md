...
|---:|---|:-:|---|---:|---:|---:|---:|---:|---:|---:|---:|:-:|---:|
| 1 | `deepseek/deepseek-v3.2` | ✅ | StreamLake | 63 | 0.229 | 0.343 | 70.0 | 70.2 | — | 1431 | 131k | **B** | 0.551 |
| 2 | `minimax/minimax-m2.5` | ✅ | Inceptron | 54 | 0.120 | 0.480 | 75.8 | — | — | 1436 | 204k | **B+** | 0.463 |
| 3 | `z-ai/glm-5` | ✅ | DeepInfra | 68 | 0.600 | 1.920 | 72.8 | — | — | 1461 | 202k | **B+** | 0.462 |
| 4 | `z-ai/glm-4.6` | ✅ | DeepInfra | 68 | 0.430 | 1.740 | 68.2 | — | — | 1458 | 202k | **B** | 0.447 |
| 5 | `z-ai/glm-4.5` | ✅ | Z.AI | 69 | 0.600 | 2.200 | 64.2 | — | — | 1448 | 131k | **C+** | 0.423 |
| 6 | `minimax/minimax-m3` | ✅ | Minimax | 94 | 0.300 | 1.200 | — | — | 44 | 1485 | 1048k | **A+** | 0.421 |
| 7 | `deepseek/deepseek-v4-flash` | ✅ | DeepInfra | 102 | 0.090 | 0.180 | — | — | 40 | 1460 | 1048k | **A** | 0.401 |
| 8 | `z-ai/glm-5.1` | ✅ | DigitalOcean | 62 | 0.966 | 3.036 | — | — | 40 | 1506 | 202k | **B** | 0.397 |
| 9 | `minimax/minimax-m2.7` | ✅ | DeepInfra | 51 | 0.180 | 0.720 | — | — | 38 | 1448 | 204k | **B-** | 0.367 |
| 10 | `moonshotai/kimi-k2.5` | ✅ | DigitalOcean | 46 | 0.375 | 2.025 | 70.8 | — | — | — | 262k | **B+** | 0.364 |
| 11 | `minimax/minimax-m2` | ✅ | Minimax | 54 | 0.255 | 1.020 | 61.0 | — | — | — | 204k | **B-** | 0.348 |
| 12 | `z-ai/glm-5.2` | ✅ | DeepInfra | 186 | 0.910 | 2.860 | — | — | 51 | — | 1048k | **A+** | 0.339 |
| 13 | `deepseek/deepseek-v4-pro` | ✅ | DeepSeek | 59 | 0.435 | 0.870 | — | — | 44 | — | 1048k | **A** | 0.315 |
| 14 | `moonshotai/kimi-k2.6` | ✅ | Inceptron | 46 | 0.660 | 3.410 | — | — | 43 | — | 262k | **B** | 0.281 |
| 15 | `moonshotai/kimi-k2.7-code` | ✅ | DeepInfra | 46 | 0.740 | 3.500 | — | — | 42 | — | 262k | **B** | 0.276 |
| 16 | `moonshotai/kimi-k2` | ✅ | Novita | 37 | 0.570 | 2.300 | — | 59.1 | — | 1402 | 131k | **C+** | 0.272 |
| 17 | `deepseek/deepseek-r1` | ✅ | Novita | 18 | 0.700 | 2.500 | — | 71.4 | — | 1382 | 163k | **B** | 0.261 |
...
| 24 | `deepseek/deepseek-v4-flash:discounted` | — | — | 108 | 0.000 | 0.000 | — | — | — | — | 1048k | **C** | 0.189 |
...
| 27 | `deepseek/deepseek-v4-pro:discounted` | — | — | 74 | 0.000 | 0.000 | — | — | — | — | 1048k | **C** | 0.181 |
| 28 | `minimax/minimax-m2-her` | ✅ | Minimax | 87 | 0.300 | 1.200 | — | — | — | — | 65k | **C** | 0.172 |
| 29 | `z-ai/glm-4.7-flash` | ✅ | DeepInfra | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **B-** | 0.171 |
...
| 32 | `minimax/minimax-m1` | ✅ | Minimax | 41 | 0.400 | 2.200 | — | — | — | 1369 | 1000k | **C** | 0.162 |
...
| 36 | `minimax/minimax-01` | ✅ | Minimax | 22 | 0.200 | 1.100 | — | — | — | — | 1000k | **C** | 0.148 |
| 37 | `z-ai/glm-5-turbo` | ✅ | AtlasCloud | 43 | 1.200 | 4.000 | — | — | — | — | 262k | **B-** | 0.129 |
| 38 | `z-ai/glm-5v-turbo` | ✅ | Z.AI | 36 | 1.200 | 4.000 | — | — | — | — | 202k | **B-** | 0.126 |
