...
**Generated:** 2026-07-13 · **Source:** `scripts/kilo-benchmarks/kilo_agents.db` · **Generator:** `scripts/kilo-benchmarks/rank_coding_subagents.py`
...
| 8 | `minimax/minimax-m3` | ✅ | Minimax | ✅ | — | 108 | 0.300 | 1.200 | — | — | 44 | 1485 | 1048k | **A+** | 0.424 |
| 9 | `z-ai/glm-4.7-flash` | ✅ | DeepInfra | ✅ | ✅ | 54 | 0.060 | 0.400 | — | — | — | — | 202k | **C+** | 0.413 |
| 10 | `deepseek/deepseek-v4-flash` | ✅ | StreamLake | ✅ | — | 101 | 0.077 | 0.154 | — | — | 40 | 1460 | 1048k | **A** | 0.401 |
| 11 | `minimax/minimax-m2.7` | ✅ | Mara | ✅ | — | 47 | 0.240 | 0.960 | — | — | 38 | 1448 | 204k | **B-** | 0.363 |
| 12 | `z-ai/glm-5.2` | ✅ | Novita | ✅ | — | 150 | 0.420 | 1.320 | — | — | 42 | — | 1048k | **A** | 0.322 |
| 13 | `deepseek/deepseek-v4-pro` | ✅ | DeepSeek | ✅ | — | 61 | 0.435 | 0.870 | — | — | 44 | — | 1048k | **A** | 0.315 |
| 14 | `qwen/qwen3-coder-next` | ✅ | Ionstream | — | — | 106 | 0.110 | 0.800 | — | — | 21 | — | 262k | **C+** | 0.250 |
| 15 | `minimax/minimax-m2.1` | ✅ | Minimax | ✅ | — | 61 | 0.300 | 1.200 | — | — | — | 1430 | 204k | **B-** | 0.225 |
| 16 | `z-ai/glm-4.5-air` | ✅ | SiliconFlow | ✅ | — | 105 | 0.130 | 0.850 | — | — | — | 1410 | 131k | **C+** | 0.224 |
...
| 2 | `z-ai/glm-4.6` | ✅ | Venice | ✅ | — | 68 | 0.430 | 1.750 | 68.2 | — | — | 1458 | 200k | **B** | 0.550 |
...
| 9 | `z-ai/glm-5.1` | ✅ | StreamLake | ✅ | — | 66 | 0.966 | 3.036 | — | — | 40 | 1506 | 202k | **B** | 0.398 |
| 10 | `moonshotai/kimi-k2.6` | ✅ | Inceptron | ✅ | — | 46 | 0.660 | 3.410 | — | — | 44 | — | 262k | **B** | 0.284 |
| 11 | `moonshotai/kimi-k2.7-code` | ✅ | Inceptron | ✅ | — | 49 | 0.720 | 3.500 | — | — | 42 | — | 262k | **B** | 0.278 |
...
| `deepseek/deepseek-v3.1-terminus` | 0.270 | 0.950 | 24 | 163k | — | ✅ | 0.151 |
