...
*Auto-generated on 2026-09-06 from `assignments.json` + `kilo_agents.db`.*
...
| P2 | **Gpt Oss 20B** | 1371 | 3.4 | ~$0.030/M / ~$0.13/M | Second highest performance-per-dollar (15233) with an Elo (1371) well above the  |
...
*Auto-generated on 2026-09-06 (UTC) from `embedding_roles` + `embedding_role_configs.yaml`. Edits between the markers will be overwritten on the next daily run.*
