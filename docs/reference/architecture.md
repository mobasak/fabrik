...
| `examples/` | **Removed** (May 2026). Had one Traycer agent review example script — pattern already documented in `docs/traycer/` and the actual script at the Traycer agent-review wrapper (retired 2026-08-15) | Removed |
