...
- **Phase 1 Tasks:** `@/opt/fabrik/tasks.md`
- **Phase 1 Narrative:** `@/opt/fabrik/docs/reference/Phase1.md`
- **Stack Overview:** `@/opt/fabrik/docs/reference/stack.md`
- **Disaster Recovery:** `@/opt/fabrik/docs/reference/disaster-recovery.md`
- **Duplicati Setup:** `@/opt/fabrik/docs/reference/duplicati-setup.md`
- **Future Development:** `@/opt/fabrik/docs/reference/future-development.md`
- **Fabrik Drivers:** `@/opt/fabrik/docs/reference/drivers.md`
