...
| **P2** | Auto-generate spec in `scaffold.py` | 4 hours | ⏳ **TODO** | Pending |
...
- AI agents must manually create spec files (step 2 above) or use `fabrik new`
...
**P2 - Auto-generate specs (4h):** `fabrik scaffold` creates spec file automatically
...
**Total remaining:** ~9 hours for high-value automation (P2+P3+P4). P5 is optional high-risk refactor.
