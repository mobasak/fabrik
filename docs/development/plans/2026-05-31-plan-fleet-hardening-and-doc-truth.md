...
### W1 — Spoke firewall parity (defense-in-depth)
...
- [ ] Telegram silenced for the W1+W2 window
- [ ] W1 step 3 — iptables backend confirmed consistent on vps2/vps3
- [ ] W1 step 4 — UFW installed + enabled on vps2, vps3 (8 ALLOW rules each)
- [ ] W1 step 5 — Bootstrap script patched if root-cause surfaced
