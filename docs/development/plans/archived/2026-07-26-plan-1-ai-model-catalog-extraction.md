...
- CREATE `engine/daily_refresh.sh` ← relocated, with the **six** fabrik tentacles severed (four known at drafting + `doc_reconcile` + `fabrik.drivers`) (see B.2).
