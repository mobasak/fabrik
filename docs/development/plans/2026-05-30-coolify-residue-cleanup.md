...
| `docs/operations/vps-urls.md` | 12 | URL table — `coolify.vps1.ocoron.com` is still a valid URL since Coolify is installed. Verify URLs match live state. |
...
- `docs/operations/coolify-migration.md` (the migration plan itself)
- `docs/reference/coolify-api-reference.md`, `coolify-openapi.json`, `coolify-services-compose-dump.txt`, `coolify-stable-aliases.md`
...
- `docs/operations/vps-status.md` — generated by `update_vps_docs.py`
...
- `docs/operations/vps-urls.md` — auto-refreshed by sync
...
4. **`docs/operations/coolify-migration.md`** — keep as historical record? Move to `docs/archive/`?
