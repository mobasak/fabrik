...
## Touches
- commands/_sources/fabrik-rules-review.md — PRIMARY PATH
- commands/_fragments/ — write window ONLY for a new fragment-level finding (serialized across tickets)
- docs/development/reviews/2026-08-31-plan-1-manifesto-command-pass-T25-fabrik-rules-review-review.md — the ticket's 63b verdict table + review artifact
