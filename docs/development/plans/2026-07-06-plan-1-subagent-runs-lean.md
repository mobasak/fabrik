...
**Status:** IN-PROGRESS (execution started 2026-07-06 — pre-flight discovery: WSL postgres uses peer auth on unix socket, scram on TCP → scripts adapted to `sudo -u postgres psql`)
**Date:** 2026-07-06
