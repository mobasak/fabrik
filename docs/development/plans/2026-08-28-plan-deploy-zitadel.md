...
Status: BLOCKED — S3 fabrik apply up --wait false-fails on health.disabled (no healthcheck) → registrars skipped; service came up but deploy incomplete
Service: zitadel
