...
Docs: INDEX.md (removed files + `_retired/` rows) · docs/README.md · CHANGELOG.md · **doc-link repair caused by this move** (bare-path refs that resolve TODAY and will not after it): `docs/CAPABILITIES.md` → `scripts/traycer_mirror.py`; `docs/traycer/fabrik-workflow.md` → `docs/traycer/traycer-agile-workflow.md`; `docs/orchestrator/traycer-command-wiring.md` → `scripts/traycer_mirror.py` — orchestrator-applied
