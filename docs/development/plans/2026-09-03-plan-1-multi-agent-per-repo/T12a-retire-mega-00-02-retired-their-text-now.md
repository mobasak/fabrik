...
Docs: INDEX.md (moved files) · docs/README.md · CHANGELOG.md · **doc-link repair caused by this move**: `agents-fabrik.md` cites `00-trigger-mega-epic-fabrik.md` and `docs/infrastructure/vps-complete-inventory.md` cites `02-epic-decomposition-fabrik.md`, both relocated here — orchestrator-applied
