...
### Phase 4 — Converge: IN PROGRESS — rounds 2–8 (delta) confirmed 14 → 12 → 11 → 13 → 16 → 14 → 14; round 8 removed round 7's re-growth (the reader's guard) and reworded the line to what was checked — no mechanism added; round 9 (delta over the round-8 diff, fresh seats) is owed
