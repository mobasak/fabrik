...
### Phase 4 — Converge: IN PROGRESS — rounds 2–4 (delta) confirmed 14 → 12 → 11 and fixed them; round 4 applied the scope-growth stop by DELETING the fallback machinery every finding since round 2 sat in (D-249); round 5 (delta over the round-4 fix diff, fresh seats) is owed
