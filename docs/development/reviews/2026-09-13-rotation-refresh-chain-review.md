...
### Phase 4 — Converge: IN PROGRESS — rounds 2–3 (delta) confirmed 14 → 12 and fixed them; round 3 rewrote the notifier gate + stamp block in one batch (D-231); round 4 (delta over the round-3 fix diff, fresh seats) is owed
