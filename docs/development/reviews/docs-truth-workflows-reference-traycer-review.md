...
| reference (15 incl. modules/, EXTERNAL_SYSTEMS) | 15 | ~404 | 11 | 3 | ALL APPLIED; EXTERNAL_SYSTEMS deduped 84→77, then 76 after the root-wave Netdata-residual removal (final: 76 headings, programmatically verified) |
...
- **EXTERNAL_SYSTEMS.md**: 13 duplicate sections removed + the Netdata residual; totals now sum (76).
