...
**Plan:** `docs/development/plans/archived/2026-09-24-plan-1-audit-log-everywhere/T05-integration-scaffold.md`
...
| T05-contract-S5 | RECORDED — by design (D-409) — test_worker_module_present stays a structural presence check; run_due's behaviour is executed against real PostgreSQL by test_run_due_against_the_emitted_schema_and_a_cursor_grant_is_an_incident |
