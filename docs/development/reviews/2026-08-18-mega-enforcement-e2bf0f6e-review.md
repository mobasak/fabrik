...
| Pass 17 | WIDE (closing #8) | (in flight — filled from the finder's ACTUAL result, never pre-written) | FRESH non-author finder over the centralized-escapes surface |
