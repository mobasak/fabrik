...
| Pass 7 | WIDE (closing #3) | (in flight — filled from the finder's ACTUAL result, never pre-written) | FRESH non-author native fabrik-reviewer over the round-6-fixed surface |
