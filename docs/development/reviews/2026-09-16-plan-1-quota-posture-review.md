...
| Delta 14 | the fix Delta 13 shipped (8 of 10: an ungraded selector, comments and one figure) and TWO timestamp shapes in the PLAN's surface (a `true` read as 1970 fail-open; a NaN wall row immortal) |
