...
| Delta 13 | the fix Delta 12 shipped (6 of 7: two comments, one doc figure, three grader arms) and ONE sibling reader in the PLAN's surface (a stray ledger line aborting the tick); the prose seat read zero |
