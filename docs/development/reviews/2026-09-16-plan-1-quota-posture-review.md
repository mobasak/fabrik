...
| Delta 11 | the fixes Delta 10 shipped (14 of 14): one code defect the re-arm created (the stamp path skipped the floor), the rest graders that proved nothing and code the refactor left dead; the writer's own seat read zero on the hook/contracts/doc slice |
