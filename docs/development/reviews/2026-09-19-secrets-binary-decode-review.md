...
| Class | Status |
|---|---|
| Hunt: `scripts/enforcement/check_secrets.py` — every changed hunk, its enclosing function, its callers | UNCHECKED |
| Hunt: `tests/test_check_secrets_placeholders.py` — every changed hunk, its enclosing function, its callers | UNCHECKED |
