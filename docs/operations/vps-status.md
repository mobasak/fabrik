...
| **Memory** | 11Gi total, 5.0Gi used, 1.4Gi free |
| **Uptime** | up 8 weeks, 2 days, 12 hours, 31 minutes |
| **Last snapshot** | 2026-05-16 10:51 UTC |
<!-- /AUTO -->
...
| `gatus-v8s4cokcwg0co4w8okkccc0w` | ✅ Up 55 seconds | 256m |
...
| `test-file-worker-toskcwwogwgcg84swg40ogkk-105313502032` | ✅ Up Less than a second (health: starting) | 512m |
...
| `test-file-worker-toskcwwogwgcg84swg40ogkk-105313502032` | 512m |
| `traefik` | 256m |
