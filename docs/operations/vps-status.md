...
| **Disk** | 108G total, 41G used, 67G free (38%) |
| **Memory** | 11Gi total, 5.1Gi used, 1.0Gi free |
| **Uptime** | up 8 weeks, 2 days, 12 hours, 38 minutes |
| **Last snapshot** | 2026-05-16 10:58 UTC |
<!-- /AUTO -->
...
| `backrest-l48000k44wc4gk8os88s8k0c` | ✅ Up 5 minutes | 512m |
...
| `coolify-sentinel` | ✅ Up 27 seconds (healthy) | — |
...
| `gatus-v8s4cokcwg0co4w8okkccc0w` | ✅ Up 5 seconds | 256m |
...
| `test-static-site-t0o8wc0ss4k0c8wo8ckkkow4-105912191038` | ✅ Up 21 seconds (healthy) | 512m |
...
| `test-static-site-t0o8wc0ss4k0c8wo8ckkkow4-105912191038` | 512m |
| `traefik` | 256m |
