...
**Last Updated:** 2026-05-16 10:47 UTC
...
| **Memory** | 11Gi total, 4.9Gi used, 749Mi free |
| **Uptime** | up 8 weeks, 2 days, 12 hours, 26 minutes |
| **Last snapshot** | 2026-05-16 10:47 UTC |
<!-- /AUTO -->
...
| `backrest-l48000k44wc4gk8os88s8k0c` | ✅ Up 13 seconds | 512m |
...
| `coolify-sentinel` | ✅ Up 48 minutes (healthy) | — |
...
| `gatus-v8s4cokcwg0co4w8okkccc0w` | ✅ Up 17 seconds | 256m |
...
| `pushgateway` | ✅ Up 5 hours (healthy) | — |
...
| `test-saas-skeleton-p888gk0cc4kgo0ww8wkg4s0w-104711956723` | ✅ Up 53 seconds (healthy) | 512m |
...
| `test-saas-skeleton-p888gk0cc4kgo0ww8wkg4s0w-104711956723` | 512m |
| `traefik` | 256m |
