...
**Date:** 2026-08-08 · **Context:** CLAUDE.md hub/project split — moving `"CLAUDE.md"` from `GOVERNANCE_FILES` to the new `GOVERNANCE_TEMPLATES` pair list.
