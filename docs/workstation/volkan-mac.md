...
| Repo working agreement (team-visible, tool-neutral) | `~/dev/cryptnshare/CLAUDE.md` § Conventions (commit `0a12b53`) + `CHANGELOG.md`, `docs/DECISIONS.md` (D-001..D-005), `docs/LESSONS_LEARNT.md`, `docs/CONFIGURATION.md` (64 vars), `docs/development/{plans,specs,reviews,rivals}/`, `docs/quality-baseline.json`, `.fvmrc` (Flutter 3.47.2) | committed on `vo-2026-09-09` |
