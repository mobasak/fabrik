...
artifact is unreadable, clock-implausible or torn short — causes the tick cannot tell apart, one of
them a send that went out, so it never says "not delivered" and names them all rather than guess).
