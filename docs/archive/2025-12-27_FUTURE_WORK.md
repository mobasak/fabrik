...
### ✅ Cloudflare DNS Driver (2025-12-25)
- Full Cloudflare API integration via VPS DNS Manager
- Zone creation, nameserver setting, DNS record sync
- Per-record CRUD (preserves existing records)
- See: `docs/step1-domain-hosting-validation.md`

### ✅ WordPress Automation - Phase 1d (2025-12-25)
- Domain provisioning fully automated
- Spec system (defaults → presets → site)
- Page generator, section renderer
- See: `docs/reference/Phase1d.md`
