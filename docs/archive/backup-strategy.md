...
>
> - **DR runbook (operator):** [`docs/operations/disaster-recovery.md`](../operations/disaster-recovery.md)
...
The Duplicati troubleshooting notes were archived. See [`docs/archive/2026-04-28-duplicati-setup.md`](../archive/2026-04-28-duplicati-setup.md).
