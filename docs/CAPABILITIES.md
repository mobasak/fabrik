...
- [core/62-using-subagents.md](../.windsurf/rules/core/62-using-subagents.md) (owner: infra): How to dispatch subagents — native Claude Task subagents for every fan-out while the OpenRouter pool is OFF by ruling (D-181/D-182), per-task tool access, the n
...
- [fabrik-generate-tests](../CLAUDE.md) (owner: infra): Generate Behavior-Contract tests for a target (module/dir/file, or a phase's Behavior Contract) with native Claude seats (the pool is OFF, D-181) — suggest (one
