---
name: fab-ettw-03-tech-plan
description: "Epic-to-ticket step 03: produce the grounded technical implementation plan. Use after core flows, or when the user types /fab-ettw-03-tech-plan."
---

<!-- GENERATED by /opt/fabrik/commands/assemble_commands.py — DO NOT HAND-EDIT; edit _sources/ + the NEXT map and re-render -->
<!-- source-of-truth for THIS wrapper: /opt/fabrik/docs/orchestrator/epic-to-ticket-workflow/03-tech-plan-fabrik.md + the ORCH_SOURCES table in assemble_commands.py (NOT _sources/ — the banner above is the generic generator stamp; orchestrator wrappers render from the canonical doc named below) -->

# fab-ettw-03-tech-plan (thin wrapper → source-of-truth in /opt/fabrik)

Read the command specification at:

`/opt/fabrik/docs/orchestrator/epic-to-ticket-workflow/03-tech-plan-fabrik.md`
...
```bash
python3 scripts/command_run.py start --command fab-ettw-03-tech-plan --phases 8 \
...
- `python3 scripts/command_run.py done --command fab-ettw-03-tech-plan --evidence "<what proves the terminal
...
- `python3 scripts/command_run.py blocked --command fab-ettw-03-tech-plan --reason "<what · searched · missing>"`
