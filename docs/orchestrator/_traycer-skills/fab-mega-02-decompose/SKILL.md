...
<!-- source-of-truth: /opt/fabrik/docs/orchestrator/mega-epic-breakdown/02-epic-decomposition-fabrik.md + the ORCH_SOURCES table -->
...
```bash
python3 scripts/command_run.py start --command fab-mega-02-decompose --phases 5 \
