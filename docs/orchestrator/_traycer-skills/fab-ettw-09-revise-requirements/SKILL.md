---
name: fab-ettw-09-revise-requirements
description: "Epic-to-ticket step 09: revise requirements/tickets when validation surfaces gaps or drift. Use when implementation validation finds gaps, or when the user types /fab-ettw-09-revise-requirements."
---

<!-- GENERATED by /opt/fabrik/commands/assemble_commands.py — DO NOT HAND-EDIT; edit _sources/ + the NEXT map and re-render -->
<!-- source-of-truth for THIS wrapper: /opt/fabrik/docs/orchestrator/epic-to-ticket-workflow/09-revise-requirements-fabrik.md + the ORCH_SOURCES table in assemble_commands.py (NOT _sources/ — the banner above is the generic generator stamp; orchestrator wrappers render from the canonical doc named below) -->

# fab-ettw-09-revise-requirements (thin wrapper → source-of-truth in /opt/fabrik)

Read the command specification at:

`/opt/fabrik/docs/orchestrator/epic-to-ticket-workflow/09-revise-requirements-fabrik.md`
...
```bash
python3 scripts/command_run.py start --command fab-ettw-09-revise-requirements --phases 9 \
