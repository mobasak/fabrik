...
<!-- source-of-truth: /opt/fabrik/docs/orchestrator/mega-epic-breakdown/00-trigger-mega-epic-fabrik.md + the ORCH_SOURCES table -->
...
```bash
python3 scripts/command_run.py start --command fab-mega-00-trigger --phases 11 \
