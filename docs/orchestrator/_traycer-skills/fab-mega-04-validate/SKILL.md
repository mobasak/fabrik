...
<!-- source-of-truth: /opt/fabrik/docs/orchestrator/mega-epic-breakdown/04-cross-epic-validation-fabrik.md + the ORCH_SOURCES table -->
...
```bash
python3 scripts/command_run.py start --command fab-mega-04-validate --phases 5 \
