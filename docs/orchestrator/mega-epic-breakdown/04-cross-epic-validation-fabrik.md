...
`python /opt/fabrik/scripts/review_rubric.py --changed <the epic files under review> --workflow mega` and
...
command-chain files — the mega authoring-QA checklist items, added by `--workflow mega`. The whole rubric
