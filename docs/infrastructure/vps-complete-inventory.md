...
| `backrest-l48000k44wc4gk8os88s8k0c` | ✅ Up 37 seconds | 512m |
...
| `coolify-sentinel` | ✅ Up 16 minutes (healthy) | — |
...
| `gatus-v8s4cokcwg0co4w8okkccc0w` | ✅ Up 31 seconds | 256m |
...
| `test-file-api-kcwwkwog0kgockg40w0w884s-141521409609` | ✅ Up 15 seconds (healthy) | 512m |
...
| `test-file-api-kcwwkwog0kgockg40w0w884s-141521409609` | 512m |
| `traefik` | 256m |
...
| `test-file-worker` | http://pwkg4o44ccos84s88oo40sg0.172.93.160.197.sslip.io | ⚠️ exited:unhealthy |
<!-- /AUTO -->
