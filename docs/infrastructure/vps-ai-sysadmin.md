...
**Last Updated:** 2026-06-04 (T-P5 dogfood Step 6 SHIPPED — per-project watchdog sidecar self-heals via Claude Code Opus end-to-end; sidecar `llm_client.py` rewritten to mirror this doc's host-sysadmin pattern verbatim)
