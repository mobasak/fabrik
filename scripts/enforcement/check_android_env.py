...
def check_android_env() -> bool:
    ...
    if not android_home:
        ...
        print("Tip: Add 'export ANDROID_HOME=/mnt/c/Users/YourUser/AppData/Local/Android/Sdk' to ~/.bashrc")
        return False
    ...
    if emulator_path.exists():
        print(f"  ✓ Android Emulator found")
    else:
        print(f"  ⚠ Android Emulator not found (optional)")
