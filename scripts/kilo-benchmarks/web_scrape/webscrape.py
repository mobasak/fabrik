...
def extract_react_props(html: str, component_id_prefix: str = "react-component-props-") -> dict:
...
class WebScraper:
    ...
    def _send_with_retry(self, url: str, *, method: str, body: str | None) -> httpx.Response:
