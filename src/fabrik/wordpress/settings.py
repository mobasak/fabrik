...
class SettingsApplicator:
    ...
    def set_homepage(self, homepage_id: int, blog_page_id: Optional[int] = None) -> dict:
        """
    ...
    def create_editor(self, email: str, username: Optional[str] = None) -> EditorCredentials:
        """
    ...
    def get_page_id_by_slug(self, slug: str) -> Optional[int]:
        """
        Get page ID by slug.
