...
class ThemeCustomizer:
    ...
    def apply_colors(self, colors: BrandColors | dict) -> dict:
        ...
        if colors.primary:
            global_colors.append({"slug": "contrast", "color": colors.primary, "name": "Primary"})
            applied["primary"] = colors.primary

        if colors.secondary:
            global_colors.append(
                {"slug": "contrast-2", "color": colors.secondary, "name": "Secondary"}
            )
            applied["secondary"] = colors.secondary

        if colors.accent:
            global_colors.append({"slug": "accent", "color": colors.accent, "name": "Accent"})
            applied["accent"] = colors.accent

        if colors.background:
            global_colors.append({"slug": "base", "color": colors.background, "name": "Background"})
            applied["background"] = colors.background

        if colors.text:
            global_colors.append({"slug": "contrast-3", "color": colors.text, "name": "Text"})
