...
class WordPressAPIClient:
    ...
    def list_pages(
        ...
        """List pages."""
        return self._request("GET", "/pages", params={
            "per_page": per_page,
            "page": page,
            "status": status,
        })
    ...
    def list_media(self, per_page: int = 10, page: int = 1) -> list[dict]:
        """List media items."""
        return self._request("GET", "/media", params={
            "per_page": per_page,
            "page": page,
        })
    ...
    def create_category(self, name: str, slug: Optional[str] = None, parent: int = 0) -> dict:
        """Create a category."""
    ...
    def create_tag(self, name: str, slug: Optional[str] = None) -> dict:
        """Create a tag."""
        data = {"name": name}
        if slug:
            data["slug"] = slug
