...
- **`/fabrik-review`** — the full command. Escalate to it for: a new mechanism outside the `/fabrik-task` lane (one that is reversible, fits 3 files and settles no trade-off stays there — D-315), any
