...
**Use ONLY these models.** Auto-updated daily by `/opt/ai-model-catalog/engine/embedding_export_markdown.py`. Called via OpenRouter `/v1/embeddings` endpoint — one API key (`OPENROUTER_API_KEY`), all providers unified.
