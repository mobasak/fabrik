...
Last content verification: 2026-07-22
...
<!-- GATEWAY_COUNTS:START — last-refreshed: 2026-07-22 (auto-managed by update_gateway_counts.py) -->
*Live gateway counts (active models, 2026-07-22 UTC; auto-refreshed from `kilo_agents.db`):*

reasoning-capable across all gateways: **207**
tool/function-calling across all gateways: **271**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-22 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-22 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*
