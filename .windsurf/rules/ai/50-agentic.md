...
Last content verification: 2026-07-15
...
<!-- GATEWAY_COUNTS:START — last-refreshed: 2026-07-15 (auto-managed by update_gateway_counts.py) -->
*Live gateway counts (active models, 2026-07-15 UTC; auto-refreshed from `kilo_agents.db`):*

reasoning-capable across all gateways: **204**
tool/function-calling across all gateways: **270**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-15 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-15 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*
