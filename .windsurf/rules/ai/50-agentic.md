...
Last content verification: 2026-07-02
...
reasoning-capable across all gateways: **197**
tool/function-calling across all gateways: **256**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-02 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-02 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*
