...
Last content verification: 2026-07-08
...
reasoning-capable across all gateways: **202**
tool/function-calling across all gateways: **265**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-08 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-08 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*
