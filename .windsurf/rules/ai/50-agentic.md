...
Last content verification: 2026-07-04
...
reasoning-capable across all gateways: **199**
tool/function-calling across all gateways: **258**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-04 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-04 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*
