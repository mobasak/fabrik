...
|---|---|---|
| **OpenRouter** | 346 | of which **343** dual-routed with Kilo, **3** OR-only |
...
Capability counts (any-gateway): reasoning **206** · tools/function-calling **272** · vision-input **178** · translation-scored **9** · STT-capable **27**.
<!-- GATEWAY_COUNTS:END -->
