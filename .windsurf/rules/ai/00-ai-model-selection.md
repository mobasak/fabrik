...
|---|---|---|
| **OpenRouter** | 339 | of which **336** dual-routed with Kilo, **3** OR-only |
| **Kilo CLI** | 336 | of which **336** dual-routed with OR, **0** Kilo-only |
...
Capability counts (any-gateway): reasoning **212** · tools/function-calling **272** · vision-input **180** · translation-scored **9** · STT-capable **32**.
<!-- GATEWAY_COUNTS:END -->
