...
|---|---|---|
| **OpenRouter** | 349 | of which **347** dual-routed with Kilo, **2** OR-only |
| **Kilo CLI** | 347 | of which **347** dual-routed with OR, **0** Kilo-only |
...
Capability counts (any-gateway): reasoning **200** · tools/function-calling **270** · vision-input **176** · translation-scored **9** · STT-capable **20**.
<!-- GATEWAY_COUNTS:END -->
