...
|---|---|---|
| **OpenRouter** | 344 | of which **340** dual-routed with Kilo, **4** OR-only |
| **Kilo CLI** | 341 | of which **340** dual-routed with OR, **1** Kilo-only |
...
Capability counts (any-gateway): reasoning **211** · tools/function-calling **274** · vision-input **181** · translation-scored **9** · STT-capable **31**.
<!-- GATEWAY_COUNTS:END -->
