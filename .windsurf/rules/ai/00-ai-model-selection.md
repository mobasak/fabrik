...
|---|---|---|
| **OpenRouter** | 338 | of which **335** dual-routed with Kilo, **3** OR-only |
...
Capability counts (any-gateway): reasoning **239** · tools/function-calling **301** · vision-input **209** · translation-scored **9** · STT-capable **41**.
<!-- GATEWAY_COUNTS:END -->
