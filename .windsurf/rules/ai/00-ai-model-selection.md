...
|---|---|---|
| **OpenRouter** | 387 | of which **351** dual-routed with Kilo, **36** OR-only |
| **Kilo CLI** | 351 | of which **351** dual-routed with OR, **0** Kilo-only |
...
Capability counts (any-gateway): reasoning **254** · tools/function-calling **320** · vision-input **217** · translation-scored **9** · STT-capable **36**.
<!-- GATEWAY_COUNTS:END -->
