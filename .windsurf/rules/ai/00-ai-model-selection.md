...
|---|---|---|
| **OpenRouter** | 384 | of which **349** dual-routed with Kilo, **35** OR-only |
| **Kilo CLI** | 349 | of which **349** dual-routed with OR, **0** Kilo-only |
...
Capability counts (any-gateway): reasoning **251** · tools/function-calling **317** · vision-input **213** · translation-scored **9** · STT-capable **28**.
<!-- GATEWAY_COUNTS:END -->
