...
|---|---|---|
| **OpenRouter** | 385 | of which **349** dual-routed with Kilo, **36** OR-only |
...
Capability counts (any-gateway): reasoning **251** · tools/function-calling **318** · vision-input **215** · translation-scored **9** · STT-capable **28**.
<!-- GATEWAY_COUNTS:END -->
