...
| **Kilo CLI** | 339 | of which **337** dual-routed with OR, **2** Kilo-only |
...
Capability counts (any-gateway): reasoning **207** · tools/function-calling **271** · vision-input **179** · translation-scored **9** · STT-capable **29**.
<!-- GATEWAY_COUNTS:END -->
