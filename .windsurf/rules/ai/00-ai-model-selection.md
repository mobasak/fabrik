...
|---|---|---|
| **OpenRouter** | 345 | of which **343** dual-routed with Kilo, **2** OR-only |
| **Kilo CLI** | 344 | of which **343** dual-routed with OR, **1** Kilo-only |
...
Capability counts (any-gateway): reasoning **204** · tools/function-calling **270** · vision-input **177** · translation-scored **9** · STT-capable **20**.
<!-- GATEWAY_COUNTS:END -->
