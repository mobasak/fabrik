...
|---|---|---|
| **OpenRouter** | 345 | of which **342** dual-routed with Kilo, **3** OR-only |
...
Capability counts (any-gateway): reasoning **211** · tools/function-calling **275** · vision-input **181** · translation-scored **9** · STT-capable **25**.
<!-- GATEWAY_COUNTS:END -->
