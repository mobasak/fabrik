...
|---|---|---|
| **OpenRouter** | 343 | of which **341** dual-routed with Kilo, **2** OR-only |
...
Capability counts (any-gateway): reasoning **200** · tools/function-calling **263** · vision-input **169** · translation-scored **9** · STT-capable **21**.
<!-- GATEWAY_COUNTS:END -->
