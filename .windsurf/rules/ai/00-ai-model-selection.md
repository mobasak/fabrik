...
|---|---|---|
| **OpenRouter** | 369 | of which **366** dual-routed with Kilo, **3** OR-only |
| **Kilo CLI** | 368 | of which **366** dual-routed with OR, **2** Kilo-only |
...
Capability counts (any-gateway): reasoning **213** · tools/function-calling **305** · vision-input **212** · translation-scored **9** · STT-capable **40**.
<!-- GATEWAY_COUNTS:END -->
