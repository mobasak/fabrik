...
|---|---|---|
| **OpenRouter** | 347 | of which **343** dual-routed with Kilo, **4** OR-only |
...
Capability counts (any-gateway): reasoning **214** · tools/function-calling **279** · vision-input **185** · translation-scored **9** · STT-capable **31**.
<!-- GATEWAY_COUNTS:END -->
