...
Last content verification: 2026-07-14
...
<!-- GATEWAY_COUNTS:START — last-refreshed: 2026-07-14 (auto-managed by update_gateway_counts.py) -->
*Live gateway counts (active models, 2026-07-14 UTC; auto-refreshed from `kilo_agents.db`):*

vision-input across all gateways: **176**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-14 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-14 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*

| Priority | OpenRouter ID | Cost ($/M in) | Context | Status |
|---|---|---|---|---|
| P1 | `openrouter/auto` | free | 2000k | free |
| P2 | `openai/gpt-5-chat` | $0.00 | 128k | GA |
