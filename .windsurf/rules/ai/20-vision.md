...
Last content verification: 2026-07-25
...
vision-input across all gateways: **185**
...
<!-- OPENROUTER_ROUTES:START — last-refreshed: 2026-07-25 (auto-managed by category_export_markdown.py) -->
*Auto-generated 2026-07-25 (UTC) by `category_route_mapper.py` → injected here by `category_export_markdown.py`. Edits between the markers will be overwritten on the next daily run.*
