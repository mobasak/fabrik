...
- Override **Infima CSS variables** in `custom.css` for theme customisation. Keep swizzling (`npm run swizzle`) to an absolute minimum — ejected internal components break on major Docusaurus upgrades.
