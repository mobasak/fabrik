...
NEXT = {
    ...
    "fabrik-spec-review": "on the user's approval: /fabrik-flows (walk the journeys first — every scaffold type) · then /fabrik-data-contract · /fabrik-ui-design (GUI) · else /fabrik-plan-after-chat.",
