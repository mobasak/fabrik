...
NEXT = {
    "fabrik-rivals": "/fabrik-spec — spec on the dossier's evidence: MATCH seeds features-to-build, BEAT seeds problems-to-solve, pricing + white-space seed positioning. Market SIZING stays owed.",
...
PARAMS = {
    ...
    "fabrik-rivals": {
        ...
        "questionbar": {"CHANGES_WHAT": "the scan itself (which market is scanned, or whether we run greenfield vs against our shipped features)",
