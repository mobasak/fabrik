   > **The exit is the verdict the round you just recorded PRINTED — read it off, do not re-derive it.**
   ...
   > was before the verdict existed. Maintained once, at
   > `/opt/fabrik/commands/_fragments/scope-growth-exit.md`; every copy is a render of it.
