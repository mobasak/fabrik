...
the ONE heavy round — the `/fabrik-execute-plan` D7 floor (≥1 Opus authoritative seat + one Sonnet seat per independent failure-class group, sized per D-186 — never a fixed three), ONE receipt — runs over the whole-plan diff at Finish.
