...
def main() -> int:
    ...
    print(
        ...
        "- **Enforcement mesh wired to this session:** the Stop hook blocks unfinished exits — FIVE"
        ...
        " run record still `running`; the prompt router suggests the owning /fabrik-* skill;"
